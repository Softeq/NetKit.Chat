        ...
        protected override void Up()
        {
            Execute(@"
                CREATE TABLE [dbo].DirectMembersSettings(
                    [DirectMemberId] [uniqueidentifier] NOT NULL,
                    [MemberId] [uniqueidentifier] NOT NULL,
                    [IsMuted] [bit] NOT NULL,
                    [IsPinned] [bit] NOT NULL,
                    [IsDisabled] [bit] NOT NULL         

                CONSTRAINT PK_DirectMembersSettings PRIMARY KEY (DirectMemberId, MemberId))

                ALTER TABLE [dbo].[DirectMembersSettings] WITH CHECK ADD CONSTRAINT [FK_DirectMembersSettings_DirectMembers_DirectMemberId] FOREIGN KEY([DirectMemberId])
